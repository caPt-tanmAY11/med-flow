...
import { Users, Mail, Lock, Loader2, ArrowLeft, Stethoscope, ShieldCheck, UserCheck } from "lucide-react";
            ...
            <div className="w-full max-w-6xl px-4 lg:px-8 relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                ...
                >
                    <div className="inline-flex items-center space-x-3">
                        ...
                        <span className="text-2xl font-bold tracking-tight text-slate-900 dark:text-white">MedFlow <span className="text-teal-600 font-light">Pro</span></span>
                    </div>
                    
                    <h1 className="text-5xl font-extrabold tracking-tight text-slate-900 dark:text-white leading-tight">
                        Empowering Healthcare <br/>
                        <span className="text-transparent bg-clip-text bg-gradient-to-r from-teal-500 to-emerald-500">Excellence.</span>
                    </h1>
                    ...
                    <div className="space-y-6 max-w-md">
                        <div className="flex items-start gap-4 p-4 rounded-xl bg-white/50 dark:bg-slate-900/50 backdrop-blur-sm border border-slate-200 dark:border-slate-800">
                            ...
                            <div>
                                <h3 className="font-semibold text-slate-900 dark:text-white">Unified Workspace</h3>
                                <p className="text-sm text-slate-500 dark:text-slate-400">Collaborate seamlessly across departments.</p>
                            </div>
                        </div>
                        <div className="flex items-start gap-4 p-4 rounded-xl bg-white/50 dark:bg-slate-900/50 backdrop-blur-sm border border-slate-200 dark:border-slate-800">
                            ...
                            <div>
                                <h3 className="font-semibold text-slate-900 dark:text-white">Clinical Efficiency</h3>
                                <p className="text-sm text-slate-500 dark:text-slate-400">Streamlined tools for better patient outcomes.</p>
                            </div>
                        </div>
                    </div>
                </motion.div>
                ...
                >
                    <div className="bg-white dark:bg-slate-900 p-8 rounded-3xl shadow-xl shadow-slate-200/50 dark:shadow-slate-950/50 border border-slate-200 dark:border-slate-800 backdrop-blur-xl relative overflow-hidden">
                        ...
                        <div className="mb-8">
                            ...
                            <h2 className="text-2xl font-bold text-slate-900 dark:text-white mb-2">Staff Portal</h2>
                            <p className="text-slate-500 dark:text-slate-400">
                                Authorized access for hospital personnel
                            </p>
                        </div>
                        ...
                        <form onSubmit={handleSignIn} className="space-y-5">
                            ...
                            <div className="space-y-2">
                                <div className="flex items-center justify-between">
                                    ...
                                    <Link href="#" className="text-xs font-medium text-teal-600 hover:text-teal-700 dark:text-teal-400">
                                        Forgot password?
                                    </Link>
                                </div>
                                <div className="relative group">
